...
function resolveDefinition(definition, types) {
  if ((0, _isReactCreateClassCall2.default)(definition)) {
    // return argument
    const resolvedPath = (0, _resolveToValue2.default)(definition.get('arguments', 0));
...
function findExportedComponentDefinition(ast, recast) {
  ...
  function exportDeclaration(path) {
    const definitions = (0, _resolveExportDeclaration2.default)(path, types).reduce((acc, definition) => {
      if (isComponentDefinition(definition)) {
        acc.push(definition);
      } else {
        const resolved = (0, _resolveToValue2.default)((0, _resolveHOC2.default)(definition));
