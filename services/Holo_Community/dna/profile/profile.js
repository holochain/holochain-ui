...
// -----------------------------------------------------------------
// Bridge to this function to save the ProfileSpec as configured by initiator in Vault
function saveProfileSpec (profileSpec) {
  var personaHash = commit("persona", personaEntry);
  return personaHash;
}

function bridgeProfileSpec (profileSpec) {
  //read the profileSpec and save it into HoloVault
  var personaHash = commit("persona", personaEntry);
  return personaHash;
}
