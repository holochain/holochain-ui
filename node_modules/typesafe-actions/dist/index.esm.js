...
function withType(type, constructorFunction) {
    var actionCreator = constructorFunction != null
        ? constructorFunction(type)
        : (function () { return ({ type: type }); });
    return Object.assign(actionCreator, { getType: function () { return type; } });
}

function createAction(actionType, creatorHandler) {
    validateActionType(actionType);
    var actionCreator = creatorHandler == null
...
function createStandardAction(actionType) {
    ...
    function constructor() {
        return withType(actionType, function (type) { return function (payload, meta) { return ({
            type: type,
            payload: payload,
            meta: meta,
        }); }; });
    ...
    function map(fn) {
        return withType(actionType, function (type) { return function (payload, meta) {
...
function createAsyncAction(requestType, successType, failureType) {
    ...
    function constructor() {
        return {
            request: withType(requestType, function (type) { return function (payload) { return ({
                type: requestType,
                payload: payload,
            }); }; }),
            success: withType(successType, function (type) { return function (payload) { return ({
                type: successType,
                payload: payload,
            }); }; }),
            failure: withType(failureType, function (type) { return function (payload) { return ({
                type: failureType,
                payload: payload,
            }); }; }),
        };
...
function isOfType(actionType, actionOrNil) {
    validateActionType(actionType);
    var assertFn = function (action) { return action.type === actionType; };
    if (actionOrNil == null) {
        return assertFn;
    }
...
function createActionDeprecated(actionType, creatorFunction) {
    ...
    if (actionType != null) {
        ...
        actionCreator.getType = function () { return actionType; };
    }
    else {
        throw new Error('first argument is missing');
    }
